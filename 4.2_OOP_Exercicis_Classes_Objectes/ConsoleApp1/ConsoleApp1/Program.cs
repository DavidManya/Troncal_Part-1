                ...
                while (keepdoing)
                {
                    ...
                    else
                    {
                        if (words[0] == "1")
                        {
                            ...
                            {
                                Console.WriteLine($"La nota media para la Asignatura {subjects[Convert.ToInt32(words[0])].Name} es {sum / quant}");
                            }  
                        }
                        else
                        {
                ...
                while (keepdoing)
                {
                    ...
                    else
                    {
                        if (words[0] == "1")
                        {
                            ...
                            {
                                Console.WriteLine($"La nota mínima en la Asignatura {subjects[Convert.ToInt32(words[0])].Name} es {min}");
                            }
                        }
                        else
                        {
                ...
                while (keepdoing)
                {
                    ...
                    else
                    {
                        if (words[0] == "1")
                        {
                            ...
                            {
                                Console.WriteLine($"La nota máxima en la Asignatura {subjects[Convert.ToInt32(words[0])].Name} es {max}");
                            }
                        }
                        else
                        {
